...
```python
IMAGE_PATH   = "~/vqs_ai_cam/images/foto.jpg"
ALARM_DIR    = "~/vqs_ai_cam/alarms"
CAPTURE_DIR  = "~/vqs_ai_cam/captures"
SOUND_DIR    = "~/vqs_ai_cam/sounds"
HTML_PATH    = "~/vqs_ai_cam/vqa_cam.html"
PORT         = 5666
